            ...
            <div className="content-header-profile bg-white pt-4 pl-4 pr-4">
                <div className="item-header-profile w-full flex justify-between items-center">
                    <div className="box-item-header-profile flex w-full">
                        <img
                            className="avatar-header w-20 h-20 rounded-full border border-gray-300 shadow-md"
                            src={AvataProfile}
                            alt=""
                        />
                        <div className=" ml-4 mt-4">
                            <p className="username-header-profile font-bold text-[17px]">
                                {formValues.name}
                            </p>
                            <div className="infor-header-profile flex items-center text-[#6B6B6B] text-[12px] mt-1">
                                <MdOutlineEmail />
                                <p className="ml-1 mr-3">{formValues.email}</p>
                                <CiLocationOn />
                                <p className="pl-1">{formValues.address}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="border-t mt-5">
                    <div className="pt-2 flex">
                        <div
                            className={
                                changeInfor === "account-infor"
                                    ? "mr-10 font-bold cursor-pointer text-[#00B27B] border-b-2 border-b-green-500"
                        ...
                        <p
                            className={
                                changeInfor === "password"
                                    ? "font-bold cursor-pointer text-[#00B27B] border-b-2 border-b-green-400"
                                    : "cursor-pointer"
                            }
            ...
            <div className="content-profile mt-4 w-full bg-white p-3">
                {changeInfor === "account-infor" ? (
                    <div className="tab-content pb-2" key="account-infor">
                        <div>
                            <p className="font-bold text-[12px] pl-2 uppercase">
                                account_information
                            </p>
                            <Box
                                component="form"
                    ...
                    <div className="tab-content" key="password">
                        <div>
                            <p className="font-bold text-[12px] pl-2">password</p>
                ...
                <Box>
                    ...
                    <div style={{ marginTop: 16 }}>
                        <CustomButton
                            variant="outlined"
                            color="primary"
                            onClick={handleCloseAvata}
                            style={{ marginRight: 8 }}>
                            close
                        </CustomButton>
                        <CustomButton variant="outlined" color="success" onClick={handleSave}>
                            save
                        </CustomButton>
                    </div>
                </Box>
